<div class="flex flex-col sm:flex-row justify-center items-center w-full">
    <input class="placeholder:italic placeholder:text-slate-400 block bg-white w-2/4 border border-slate-300 rounded-md py-2 pl-3 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm ml-0" placeholder="Search Listings..." type="text" wire:model.debounce.400ms="query" />
